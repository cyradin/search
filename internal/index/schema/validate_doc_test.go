...
func Test_ValidateDoc(t *testing.T) {
	t.Run("must fail for missing required fields", func(t *testing.T) {
		s := New(map[string]Field{"value": {Type: TypeBool, Required: true, Name: "value"}}, nil)
		err := ValidateDoc(s, map[string]interface{}{"value2": true})
		require.Error(t, err)
	})

	t.Run("must not fail for missing not required fields", func(t *testing.T) {
		s := New(map[string]Field{"value": {Type: TypeBool, Required: false, Name: "value"}}, nil)
		err := ValidateDoc(s, map[string]interface{}{"value2": true})
		require.Error(t, err)
	})
	...
	t.Run("must fail if invalid value type provided", func(t *testing.T) {
		...
		t.Run("keyword", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeKeyword, Required: false, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": true})
			require.Error(t, err)
		})
		t.Run("text", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeText, Required: false, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": true})
			require.Error(t, err)
		})
		t.Run("byte", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeByte, Required: false, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": true})
			require.Error(t, err)
		})
		t.Run("short", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeShort, Required: false, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": true})
			require.Error(t, err)
		})
		t.Run("integer", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeInteger, Required: false, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": true})
			require.Error(t, err)
		})
		t.Run("long", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeLong, Required: false, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": true})
			require.Error(t, err)
		})
		t.Run("unsigned long", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeUnsignedLong, Required: false, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": true})
			require.Error(t, err)
		})
		t.Run("float", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeFloat, Required: false, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": true})
			require.Error(t, err)
		})
		t.Run("double", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeDouble, Required: false, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": true})
			require.Error(t, err)
		})
	})
	...
	t.Run("must not fail if valid value provided", func(t *testing.T) {
		...
		t.Run("keyword", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeKeyword, Required: true, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": "text"})
			require.NoError(t, err)
		})
		t.Run("text", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeText, Required: true, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": "text"})
			require.NoError(t, err)
		})
		t.Run("byte", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeByte, Required: true, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": json.Number("100")})
			require.NoError(t, err)
		})
		t.Run("short", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeShort, Required: true, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": json.Number("1000")})
			require.NoError(t, err)
		})
		t.Run("integer", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeInteger, Required: true, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": json.Number("100000")})
			require.NoError(t, err)
		})
		t.Run("long", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeLong, Required: true, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": json.Number("3000000000")})
			require.NoError(t, err)
		})
		t.Run("unsigned long", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeUnsignedLong, Required: true, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": json.Number("10000000000000000000")})
			require.NoError(t, err)
		})
		t.Run("float", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeFloat, Required: true, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": json.Number("3000000000")})
			require.NoError(t, err)
		})
		t.Run("double", func(t *testing.T) {
			s := New(map[string]Field{"value": {Type: TypeDouble, Required: true, Name: "value"}}, nil)
			err := ValidateDoc(s, map[string]interface{}{"value": json.Number("3000000000")})
			require.NoError(t, err)
		})
	})
